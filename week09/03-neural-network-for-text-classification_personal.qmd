...
max_words <- 1000 #this is the number of words
...
model %>%
  layer_dense(units = 512, input_shape = c(max_words)) %>%  #512 neurons. Why? This is an empirical question. Our matrix will have 512*1,000 = 512 000 
...
The benchmark would be 1/46 =0.02 = 2%
