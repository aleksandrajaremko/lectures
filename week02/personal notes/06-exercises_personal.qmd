...
#Set the local path
tweets <- paste0("C:/Users/jarem/OneDrive/Dokumenty/LSE (personal cloud)/Coursework/MY459 Quant text analysis/Github materials/week02/personal notes/trump-tweets.json") %>%
  parseTweets() %>%
  tibble() 
