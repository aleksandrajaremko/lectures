...
#Set the local path
wdir <- "C:\\Users\\jarem\\OneDrive\\Dokumenty\\LSE (personal cloud)\\Coursework\\MY459 Quant text analysis\\Githubcmterials\\week02\\personal notes" 
lfile <- file.path(wdir, "trump-tweets.json") 
